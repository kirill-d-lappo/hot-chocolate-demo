...
{
    protected NamedFilterFieldDescriptor(IDescriptorContext context, string scope, string fieldName) : base(context,
        scope, fieldName)
    {
    }

    protected NamedFilterFieldDescriptor(IDescriptorContext context, string scope, MemberInfo member) : base(context,
        scope, member)
    {
    }

    protected NamedFilterFieldDescriptor(IDescriptorContext context, string scope, Expression expression) : base(
        context, scope, expression)
    {
    }
